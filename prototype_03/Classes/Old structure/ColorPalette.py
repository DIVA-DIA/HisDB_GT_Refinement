...
class ColorPalette():
    ...
    DECORATION = [0, 120, 0]
    COMMENT = [120, 0, 0]
    # TODO: find out if it makes sense to have a s
    BOUNDARYPIXEL = [240, 0, 0]

    # initializing two color palettes
    def __init__(self):
...
class AllDifferentColors(ColorPalette):
    ...
    def create_color_palette(n_colors):
        ...
        unsorted = [tuple([x * interval, y * interval, z * interval]) for x in my_range for y in my_range for z in
                    my_range]
