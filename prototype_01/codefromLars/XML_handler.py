...
# Questions:
# What's param baslines? -> I assume a list of points?

def writePAGEfile(output_path, text_lines="", text_region_coords="not provided", baselines=None):
    """
    Both the baslines and the text_lines need to have the same length
    :param output_path:
    :param text_lines: probably just a normal string
    :param text_region_coords:
    :param baselines:
    :return:
    """
    ...
    ET.SubElement(metadata, "Creator").text = "Max Haller"
